<h1>729 - My Calendar I</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/my-calendar-i/">my-calendar-i</a></h2><p>You are implementing a program to use as your calendar. We can add a new event if adding the event will not cause a <strong>double booking</strong>.</p>
