<h1>2337 - Remove Digit From Number to Maximize Result</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/remove-digit-from-number-to-maximize-result/">remove-digit-from-number-to-maximize-result</a></h2><p>You are given a string <code>number</code> representing a <strong>positive integer</strong> and a character <code>digit</code>.</p>
