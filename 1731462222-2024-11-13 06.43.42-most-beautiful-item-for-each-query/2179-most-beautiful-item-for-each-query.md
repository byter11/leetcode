<h1>2179 - Most Beautiful Item for Each Query</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/most-beautiful-item-for-each-query/">most-beautiful-item-for-each-query</a></h2><p>You are given a 2D integer array <code>items</code> where <code>items[i] = [price<sub>i</sub>, beauty<sub>i</sub>]</code> denotes the <strong>price</strong> and <strong>beauty</strong> of an item respectively.</p>
